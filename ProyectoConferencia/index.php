<?php include_once 'includes/templates/header.php'; ?>
    ...
    <section class="seccion contenedor">
        <h2>
            La mejor conferencia de emprendedores
        </h2>
        <p>
   ...
   <nav class="menu-programa">
     <?php while($cat  = $resultado->fetch_array()) { ?>
    ...
    <?php
        try {
          require_once('includes/funciones/db_conexion.php'); //Realizamos una multiconsulta seleccionando los elementos de categorias por su id y asignandole un limite de 2, luego utilizamos un do while con multi_query para poder imprimirlos ya que sino se imprime uno id.
